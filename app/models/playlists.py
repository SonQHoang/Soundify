...
playlist_songs_association = db.Table('playlist_songs',
...
class Playlists(db.Model):
    ...
    playlist_songs = db.relationship('Songs', secondary=playlist_songs_association, back_populates='song_playlists')
